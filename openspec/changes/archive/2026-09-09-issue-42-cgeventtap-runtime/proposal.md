...
- Add deterministic tests through the native adapter boundary, reverse-configured canonical live smoke, and release-build reference-Mac production callback-body latency evidence; synthetic timing is diagnostic only.
